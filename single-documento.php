...
?>
    <main id="main-container" class="main-container redbrown">
        ...
        <?php while ( have_posts() ) : the_post();
            ...
            $file_documenti         = dci_get_meta( "file_documenti" );
            $licenza                = dci_get_meta( "licenza" );
            $servizi_collegati      = dci_get_meta( "servizi_collegati" );
           // $link_servizi_collegati = dci_get_meta( "link_servizi_collegati" );
            $timeline               = dci_get_meta( "timeline" );
            $ufficio                = dci_get_meta( "ufficio" );
            $numerazione_albo       = dci_get_meta( "numerazione_albo" );
            $altre_info = dci_get_meta("altre_info");
            $protocollo = dci_get_meta("protocollo");
            $riferimenti_normativi = dci_get_meta("riferimenti_normativi");
            ?>
                    ...
                    <div class="row variable-gutters">
                        ...
                        <div class="col-12 col-sm-9 col-lg-5 col-md-8">
                            <div class="section-title">
                                <?php if(dci_is_albo($post) && $numerazione_albo){ ?>
                                    <small class="h6 text-redbrown"><?php echo $numerazione_albo; ?></small>
                                <?php } ?>
                                <h2 class="mb-3"><?php the_title(); ?></h2>
                                <p><?php echo dci_get_meta( "descrizione" ); ?></p>
                            </div><!-- /title-section -->
                    ...
                    <div class="row variable-gutters">
                                ...
                                <div class="aside-title">
                                    <a class="toggle-link-list" data-toggle="collapse" href="#lista-paragrafi"
                                       role="button" aria-expanded="true" aria-controls="lista-paragrafi">
                                        <span><?php _e( "Indice della pagina", "design_comuni_italia" ); ?></span>
                                    ...
                                    <ul class="link-list">
                                        <li>
                                            <a class="list-item scroll-anchor-offset" href="#art-par-descrizione"
                                               title="Vai al paragrafo <?php _e( "Descrizione", "design_comuni_italia" ); ?>"><?php _e( "Descrizione", "design_comuni_italia" ); ?></a>
                                        </li>
                                        <?php if ( is_array( $file_documenti ) && count( $file_documenti ) > 0 ) { ?>
                                        <li>
                                            <a class="list-item scroll-anchor-offset" href="#art-par-documento"
                                               title="Vai al paragrafo <?php _e( "Il Documento", "design_comuni_italia" ); ?>"><?php echo _n( 'Il Documento', 'I Documenti', count( $file_documenti ), 'design_comuni_italia' ); ?></a>
                                        </li>
                                        <?php }
                                        if ( is_array( $servizi_collegati ) && count($servizi_collegati) > 0 ) { ?>
                                            <li>
                                                <a class="list-item scroll-anchor-offset" href="#art-par-servizio"
                                                   title="Vai al paragrafo <?php _e( "Servizi collegati", "design_comuni_italia" ); ?>"><?php _e( "Servizi collegati", "design_comuni_italia" ); ?></a>
                                            </li>
                                        <?php }
                                        if ( is_array( $timeline ) && count( $timeline ) > 0 ) { ?>
                                            <li>
                                                <a class="list-item scroll-anchor-offset" href="#art-par-tempi"
                                                   title="Vai al paragrafo <?php _e( "Tempi e scadenze", "design_comuni_italia" ); ?>"><?php _e( "Tempi e scadenze", "design_comuni_italia" ); ?></a>
                                            </li>
                                        <?php }
                                        if ( is_array( $ufficio ) && count( $ufficio ) > 0 ) { ?>
                                            <li>
                                                <a class="list-item scroll-anchor-offset" href="#art-par-contatti"
                                                   title="Vai al paragrafo <?php _e( "Contatti", "design_comuni_italia" ); ?>"><?php _e( "Contatti", "design_comuni_italia" ); ?></a>
                                            </li>
                                        <?php } ?>
                        ...
                        <div class="main-content col-lg-8 col-md-8 offset-lg-1 pt84">
                            <article class="article-wrapper">
                                <h4 id="art-par-descrizione"><?php _e( "Descrizione", "design_comuni_italia" ); ?></h4>
                                <div class="row variable-gutters">
                                    <div class="col-lg-9">
                                ...
                                <div class="row variable-gutters mb-4">
                                    <div class="col-lg-12">
                                        ...
                                        if ( is_array( $autori ) && count( $autori ) > 0 ) {
                                            ?>
                                            <h6><?php _e( "Autori", "design_comuni_italia" ); ?></h6>
                                ...
                                <?php if ( is_array( $file_documenti ) && count( $file_documenti ) > 0 ) { ?>
                                    ...
                                    <h6><?php _e("Allegati", "design_comuni_italia"); ?></h6>
                                    <?php
                                    if (dci_is_albo($post) && $post->post_status == "annullato") {
                                        ?>
                                        <div class="row variable-gutters mb-4">
                                            <div class="col-lg-12">
                                                <h5 class="text-redbrown"><?php _e("Allegati non disponibili - Albo Annullato", "design_comuni_italia"); ?></h5>
                                            </div>
                                        </div>
                                        <?php
                                    } else {
                                        ...
                                        if ( is_array( $servizi_collegati ) && count($servizi_collegati) > 0 ) { ?>
                                    <h4 id="art-par-servizio"><?php _e( "Servizi collegati", "design_comuni_italia" ); ?></h4>
                                    <div class="row variable-gutters mb-4">
                                        <div class="col-lg-12">
                                            <div class="card-deck card-deck-spaced">
                                ...
                                if ( is_array( $timeline ) && count( $timeline ) > 0 ) {
                                    ?>
                                    <h4 id="art-par-tempi"><?php _e( "Tempi e scadenze", "design_comuni_italia" ); ?></h4>
                                    <div class="row variable-gutters">
                                        <div class="col-lg-9">
                                ...
                                if ( is_array( $ufficio ) && count( $ufficio ) > 0 ) { ?>
                                    ...
                                    <h6><?php _e( "Ufficio responsabile del documento", "design_comuni_italia" ); ?></h6>
                                    <div class="row variable-gutters mb-4">
                                        <div class="col-lg-12">
                                            <div class="card-deck card-deck-spaced">
                                                <?php
                                ...
                                if(($altre_info != "") || ($protocollo != "")  || ($riferimenti_normativi != "")) {
                                    ...
                                    ?>
                                    <h4 id="art-par-info"><?php _e("Ulteriori informazioni", "design_comuni_italia"); ?></h4>
                                    <div class="row variable-gutters mb-4">
                                        <div class="col-lg-9">
                                            <?php
                                            ...
                                            if ($riferimenti_normativi) {
                                                ?>
                                                <h6><?php _e("Riferimenti normativi", "design_comuni_italia"); ?></h6>
