...
?>
    <main id="main-container" class="main-container redbrown">
        ...
        $i=0;
        $strutture_documenti = dci_get_option("strutture_documenti", "documenti");
                                    ...
                                    <div class="row variable-gutters mt-4">
                                        <div class="col-lg-10 offset-lg-1 mb-4">
                                            <h4 class="text-left mb-3">
                                                <a href="<?php echo get_term_link($tipologia_documento); ?>"><?php if (count($documenti) > 1) echo dci_pluralize_string($tipologia_documento->name); else echo $tipologia_documento->name; ?></a>
                                            </h4>
                                        </div><!-- /col-lg-3 -->
                                        <?php
