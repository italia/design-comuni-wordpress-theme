...
?>
    ...
    <main id="main-container" class="main-container redbrown">
        ...
        $elementi_di_interesse = dci_get_meta("elementi_di_interesse");

        $descrizione_breve = dci_get_meta("descrizione_breve");
        $anno_costruzione = dci_get_meta("anno_costruzione");
        $numero_piani = dci_get_meta("numero_piani");
        $posti_sedere = dci_get_meta("posti_sedere");
        $gallery = dci_get_meta("gallery");
        $video = dci_get_meta("video");
        $link_strutture = dci_get_meta("link_strutture");
        $orario_pubblico = dci_get_meta("orario_pubblico");
        $altre_info = dci_get_meta("info");
        $servizi_presenti = dci_get_meta("servizi_presenti");
        $servizi_altro = dci_get_meta("servizi_altro");

        $modalita_accesso = dci_get_meta("modalita_accesso");
        $gestito_da  = dci_get_meta("gestito_da");
        $gestito_da_nome  = dci_get_meta("gestito_da_nome");
        $gestito_da_link  = dci_get_meta("gestito_da_link");
        $gestito_da_persone  = dci_get_meta("gestito_da_persone");

	      $indirizzo = dci_get_meta("indirizzo");
        $posizione_gps = dci_get_meta("posizione_gps");
        $cap = dci_get_meta("cap");
        $mail = dci_get_meta("mail");
        $telefono = dci_get_meta("telefono");
	    
        if($post->post_parent == 0){
           
        }else{
	        if(!$indirizzo) $indirizzo = dci_get_meta("indirizzo", "_dci_luogo_", $post->post_parent);
            if(!$posizione_gps) $posizione_gps = dci_get_meta("posizione_gps", "_dci_luogo_", $post->post_parent);
            if(!$cap) $cap = dci_get_meta("cap", "_dci_luogo_", $post->post_parent);
            if(!$mail) $mail = dci_get_meta("mail", "_dci_luogo_", $post->post_parent);
            if(!$telefono) $telefono = dci_get_meta("telefono", "_dci_luogo_", $post->post_parent);
        }
        ?>
                    ...
                    <div class="row variable-gutters">
                            ...
                            <aside class="aside-main aside-sticky">
                                <div class="aside-title">
                                    <a class="toggle-link-list" data-toggle="collapse" href="#lista-paragrafi" role="button" aria-expanded="true" aria-controls="lista-paragrafi">
                                        <span><?php _e("Dettagli del luogo", "design_comuni_italia"); ?> <?php the_title(); ?></span>
                                ...
                                <div id="lista-paragrafi" class="link-list-wrapper collapse show">
                                    <ul class="link-list">
                                        <?php if($video){ ?>
                                            <li>
                                                <a class="list-item scroll-anchor-offset" href="#art-par-video" title="Vai al paragrafo <?php _e("Video", "design_comuni_italia"); ?>"><?php _e("Video", "design_comuni_italia"); ?></a>
                                            </li>
                                        <?php } ?>
                                        <li>
                                            <a class="list-item scroll-anchor-offset" href="#art-par-desc" title="Vai al paragrafo <?php _e("Descrizione", "design_comuni_italia"); ?>"><?php _e("Descrizione", "design_comuni_italia"); ?></a>
                                        </li>
                                        <?php
                                        // do action per innestare elementi tramite plugin / child theme
                                        do_action("dci_luogo_menu_after_description");
                                        ?>
                                        <li>
                                            <a class="list-item scroll-anchor-offset" href="#art-par-dove" title="Vai al paragrafo <?php _e("Dove si trova", "design_comuni_italia"); ?>"><?php _e("Dove si trova", "design_comuni_italia"); ?></a>
                                        </li>
                                        <?php /* if($modalita_accesso){ ?>
                                        <li>
                                          <a class="list-item scroll-anchor-offset" href="#art-par-accesso" title="Vai al paragrafo <?php _e("Modalità di accesso", "design_comuni_italia"); ?>"><?php _e("Modalità di accesso", "design_comuni_italia"); ?></a>
                                        </li>
                                        <?php }  */ ?>
                                        <?php if($servizi_presenti || $servizi_altro){ ?>
                                            <li>
                                                <a class="list-item scroll-anchor-offset" href="#art-par-servizi" title="Vai al paragrafo <?php _e("Servizi presenti", "design_comuni_italia"); ?>"><?php _e("Servizi presenti", "design_comuni_italia"); ?></a>
                                            </li>
                                        <?php } ?>
                                        <?php if($link_strutture){ ?>
                                            <li>
                                                <a class="list-item scroll-anchor-offset" href="#art-par-strutture" title="Vai al paragrafo <?php _e("Il luogo è sede di", "design_comuni_italia"); ?>"><?php _e("Il luogo è sede di", "design_comuni_italia"); ?></a>
                                            </li>
                                        <?php } ?>
                                        <?php if($gestito_da_nome != "" || (is_array($gestito_da) && count($gestito_da)> 0) || (is_array($gestito_da_persone) && count($gestito_da_persone) > 0)){ ?>
                                            <li>
                                                <a class="list-item scroll-anchor-offset" href="#art-par-gestione" title="Vai al paragrafo <?php _e("Gestito da", "design_comuni_italia"); ?>"><?php _e("Gestito da", "design_comuni_italia"); ?></a>
                                            </li>
                                        <?php } ?>
                                        <?php if(trim($altre_info) != ""){ ?>
                                            <li>
                                                <a class="list-item scroll-anchor-offset" href="#art-par-altre-info" title="<?php _e("Vai al paragrafo", "design_comuni_italia"); ?> <?php _e("Ulteriori informazioni", "design_comuni_italia"); ?>"><?php _e("Ulteriori informazioni", "design_comuni_italia"); ?></a>
                                            </li>
                                        <?php } ?>
                                        <?php if((trim($anno_costruzione) != "") || (trim($numero_piani) != "")|| (trim($posti_sedere) != "")){ ?>
                                            <li>
                                                <a class="list-item scroll-anchor-offset" href="#art-par-dettagli" title="Vai al paragrafo <?php _e("Dettagli edificio", "design_comuni_italia"); ?>"><?php _e("Dettagli edificio", "design_comuni_italia"); ?></a>
                                            </li>
                                        <?php } ?>
                                        <?php if(is_array($gallery) && count($gallery) > 0){ ?>
                                            <li>
                                                <a class="list-item scroll-anchor-offset" href="#art-par-galleria" title="Vai al paragrafo <?php _e("Galleria", "design_comuni_italia"); ?>"><?php _e("Galleria", "design_comuni_italia"); ?></a>
                                            </li>
                                        <?php } ?>
                                    </ul>
                                </div>
                                <?php do_action("dci_menu_bottom_items", $post); ?>
                            </aside>
                        </div>
                        <div class="main-content col-lg-8 col-md-8 offset-lg-1">
                            <article class="article-wrapper pt-4">
                                ...
                                <?php
                                if($video) {?>
                                    <h4 id="art-par-video"><?php _e("Video", "design_comuni_italia"); ?></h4>
                                ...
                                <div class="row variable-gutters">
                                    <div class="col-lg-9">
                                        <h4 id="art-par-desc"><?php _e("Descrizione", "design_comuni_italia"); ?></h4>
                                        ...
                                        if($post->post_parent == 0){
                                            ...
                                            if(is_array($children) && count($children)>0){
                                                echo "<h6>".__("Ospita", "design_comuni_italia")."</h6>";
                                                echo '<div class="card-deck card-deck-spaced">';
                                                foreach ($children as $child) {
                                                    $descrizione_breve_child = dci_get_meta("descrizione_breve", "", $child->ID);
                                                    ?>
                                        ...
                                        <?php
                                        // do action per innestare elementi tramite plugin / child theme
                                        do_action("dci_luogo_content_after_description");
                                        ?>
                                        <?php
                                        if(is_array($elementi_di_interesse) && $elementi_di_interesse != ""){
                                            ?>
                                            <h6><?php _e("Elementi di interesse", "design_comuni_italia"); ?></h6>
                                            <div class="card-deck card-deck-spaced mb-4 card_container_accordion">
                                                ...
                                                foreach ($elementi_di_interesse as $elemento){
                                                    ...
                                                    $description_length = dci_get_option("excerpt_length", "luoghi");
                                                    $descrizione_excerpt = dci_truncate($descrizione, $description_length, ' ', '');
                                                    ...
                                                    <div class="card card-bg card-bg-simple rounded card_accordion">
                                                        <div class="card-body">
                                                            <div id="dci_description_container_<?php echo $count; ?>">
                                                                <p><?php echo $elemento["titolo"]; ?></p>
                                                                <small>
                                                                    <span id="dci_description_<?php echo $count; ?>"><?php echo $descrizione_excerpt; ?></span>
                                                                    <?php if(!empty($descrizione_more)): ?>
                                                                    <p style="position: absolute; left: -9999em" id="dci_description_more_<?php echo $count; ?>"><?php echo $descrizione_more; ?></p>
                                                                    <?php endif; ?>
                                                                </small>
                                                            </div>
                                                            <a href="#" class="show small dci_more" data-id="<?php echo $count; ?>">Visualizza altro</a>
                                                        </div><!-- /card-body -->
                                ...
                                <h4 id="art-par-dove"><?php _e("Dove si trova", "design_comuni_italia"); ?></h4>
                                <?php
                                global $lg;
                                $lg=12;
                                get_template_part("template-parts/luogo/card"); ?>
                                <?php if($modalita_accesso){ ?>
                                    <h6><?php _e("Modalità di accesso", "design_comuni_italia"); ?></h6>
                                    <div class="row variable-gutters mb-5">
                                        <div class="col-lg-12">
                                ...
                                <?php if($servizi_presenti || $servizi_altro){ ?>
                                    <h4 id="art-par-servizi" class="mb-4"><?php _e("Servizi presenti", "design_comuni_italia"); ?></h4>
                                ...
                                <?php if($link_strutture){ ?>
                                    <h4 id="art-par-strutture" class="mb-4"><?php _e("Il luogo è sede di", "design_comuni_italia"); ?></h4>
                                ...
                                <?php } ?>
                                <?php if($gestito_da_nome != "" || (is_array($gestito_da) && count($gestito_da)> 0) || (is_array($gestito_da_persone) && count($gestito_da_persone) > 0)){ ?>
                                    <h4 id="art-par-gestione"><?php _e("Gestito da", "design_comuni_italia"); ?></h4>
                                    <?php if(is_array($gestito_da) && count($gestito_da)> 0){ ?>
                                        <h6><?php _e("Strutture che gestiscono il luogo", "design_comuni_italia"); ?></h6>
                                        <div class="row variable-gutters">
                                            <div class="col-lg-12">
                                                <div class="card-deck card-deck-spaced">
                                                    <?php
                                    ...
                                    <?php if(is_array($gestito_da_persone) && count($gestito_da_persone)>0){ ?>
                                        <h6><?php _e("Persone che gestiscono il luogo", "design_comuni_italia"); ?></h6>
                                            ...
                                            <div class="col-lg-9">
                                                ...
                                                <?php if($gestito_da_link != ""){ ?>
                                                    <div class="btn-wrapper mb-5">
                                                        <a class="btn btn-redbrown" href="<?php echo $gestito_da_link; ?>"><?php _e("Vai alla pagina del gestore", "design_comuni_italia"); ?></a>
                                                    </div>
                                                <?php } ?>
                                            </div><!-- /col-lg-9 -->
                                        </div><!-- /row -->
                                ...
                                if(trim($altre_info) != ""){
                                    ?>
                                    <h4 id="art-par-altre-info"><?php _e("Ulteriori informazioni", "design_comuni_italia"); ?></h4>
                                    <div class="row variable-gutters">
                                ...
                                ?>
                                <?php if((trim($anno_costruzione) != "") || (trim($numero_piani) != "") || (trim($posti_sedere) != "") ){ ?>
                                    <h4 id="art-par-dettagli"><?php _e("Dettagli edificio", "design_comuni_italia"); ?></h4>
                                    <div class="row variable-gutters">
                                        <div class="col-lg-9">
                                            <div class="big-data-rounded-icon">
                                                <div class="big-data-rounded-icon-wrapper">
                                                    ...
                                                    <!-- <svg width="100%" height="100%" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:1.41421;">
                                                        <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-search"></use>
                                                    </svg> -->
                                                </div><!-- /big-data-rounded-icon-wrapper -->
                                                <div class="big-data-rounded-icon-content">
                                                <?php if($anno_costruzione){ ?>
                                                    <h4><?php _e("Anno di costruzione", "design_comuni_italia"); ?></h4>
                                                    <p><?php echo $anno_costruzione; ?></p>
                                                <?php } ?>
                                                <?php if($numero_piani){ ?>
                                                    <h4><?php _e("Numero di piani", "design_comuni_italia"); ?></h4>
                                                    <p><?php echo $numero_piani; ?></p>
                                                <?php } ?>
                                                <?php if($posti_sedere){ ?>
                                                    <h4><?php _e("Posti a sedere", "design_comuni_italia"); ?></h4>
                                ...
                                <?php } ?>
                                <?php do_action("dci_content_bottom_items", $post); ?>
                            </article>
                        </div><!-- /col-lg-8 -->
                    </div><!-- /row -->
                </div><!-- /container -->
                ...
                <section class="section bg-gray-light py-5" id="art-par-galleria">
                    <div class="container py-4">
                        <div class="title-section text-center mb-5">
                            <h3 class="h4"><?php _e("Gallery", "design_comuni_italia"); ?> <?php the_title(); ?></h3>
                        </div><!-- /title-large -->
                        <div class="row variable-gutters">
                            <div class="col">
