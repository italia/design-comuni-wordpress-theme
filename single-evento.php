...
?>
    ...
    <main>
		...
		while ( have_posts() ) :
			...
			if ( $luogo_evento_id ) {
				$luogo_evento = get_post( $luogo_evento_id );
			}
                ...
                <div class="row">
                    <div class="col-lg-8 px-lg-4 py-lg-2">
						...
						<?php if ( $start_timestamp && $end_timestamp ) { ?>
                            <h2 class="h4 py-2" data-audio>dal <?php echo $start_date; ?>
                                al <?php echo $end_date; ?></h2>
						<?php } ?>
                        <p data-audio>
                    ...
                    <section class="col-lg-8 it-page-sections-container border-light">
						...
						<?php if ( $start_timestamp && $end_timestamp ) { ?>
                            <article id="date-e-orari" class="it-page-section mb-5">
                                            ...
                                            <div class="card card-teaser shadow rounded">
                                                <div class="card-body">
                                                    <h3 class="card-title h5 m-0">
														<?php echo $start_date_arr[3] . ':' . $start_date_arr[4]; ?> -
                                                        Inizio evento
                                                    </h3>
                                                </div>
                                            </div>
                                    ...
                                    <div class="point-list">
                                        ...
                                        <div class="point-list-content">
                                            <div class="card card-teaser shadow rounded">
                                                <div class="card-body">
                                                    <h3 class="card-title h5 m-0">
														<?php echo $end_date_arr[3]; ?>:<?php echo $end_date_arr[4]; ?>
                                                        - Fine evento
                                                    </h3>
                                                </div>
                                            </div>
                                ...
                                <p class="font-serif">
                                    Per informazioni sul programma dettagliato degli appuntamenti religiosi e civili,
                                ...
                                <div class="mt-5">
                                    <a target="_blank"
                                       href="https://calendar.google.com/calendar/r/eventedit?text=<?php echo urlencode( get_the_title() ); ?>&dates=<?php echo $data_inizio; ?>/<?php echo $data_fine; ?>&details=<?php echo urlencode( $descrizione_breve ); ?>:+<?php echo urlencode( get_permalink() ); ?>&location=<?php echo urlencode( $luogo ); ?>"
                      ...
                      <span>
                                ...
                                <div class="card card-teaser shadow mt-3 rounded">
                                    <div class="card-body">
                                        <h3 class="card-title h5 m-0">
                                            ...
                                            <a class="text-decoration-none" href="<?php echo $doc->guid; ?>"
                                               title="Scarica la locandina <?php echo $doc->post_title; ?>"
                                               aria-label="Scarica la locandina <?php echo $doc->post_title; ?>"><?php echo $doc->post_title; ?></a>
                                        </h3>
                                    </div>
                                </div>
                            </article>
                            ...
                            <article id="ulteriori-informazioni" class="it-page-section mb-5">
								...
								<?php if ( is_array( $patrocinato ) && count( $patrocinato ) ) {
									...
									foreach ( $patrocinato as $item ) { ?>
                                        <li><a class="list-item px-0" href="<?php echo $item['_dci_evento_url']; ?>"
                                               target="_blank"><span><?php echo $item['_dci_evento_nome']; ?></span></a>
                                        </li>
									<?php }
									echo '</ul></div>';
								}
						...
						<?php }
						get_template_part( 'template-parts/single/page_bottom' ); ?>
                    </section>
                </div>
            </div>
