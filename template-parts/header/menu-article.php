	...
	<div class="row variable-gutters">
		...
		<div class="col-lg-7">
			<div class="article-content">
				<?php
				$argomenti = dci_get_argomenti_of_post($item);
				if(count($argomenti)) {
					$c=0;
					?>
					<div class="details"> in
						...
						foreach ( $argomenti as $argomento ) {
							if($c) echo ", "; $c++;
							?>
							<a href="<?php echo get_term_link($argomento); ?>" title="<?php _e("Vai all'argomento", "design_comuni_italia"); ?>: <?php echo $argomento->name; ?>"><?php echo $argomento->name; ?></a><?php
						} ?>
					</div>
					<?php
				}
