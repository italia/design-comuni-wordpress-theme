    ...
    <div class="row g-4">
        ...
        <div class="col-12 col-md-6 col-lg-4">
            ...
            <div class="card shadow-sm rounded">
                <div class="card-body">
                <a class="text-decoration-none" href="<?php echo $page['link']; ?>" data-element="administration-element"><h3 class="card-title t-primary title-xlarge"><?php echo $page_name; ?></h3></a>
