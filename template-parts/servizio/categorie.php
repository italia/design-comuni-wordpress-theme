        ...
        <div class="col-md-6 col-xl-4">
            <div class="cmp-card-simple card-wrapper pb-0 rounded border border-light">
                <div class="card shadow-sm rounded">
                    <div class="card-body">
                        <a class="text-decoration-none" href="<?php echo $url; ?>" aria-label="Vai all'argomento <?php echo $categoria->name; ?>" title="Vai all'argomento <?php echo $categoria->name; ?>" data-element="service-category-link"><h3 class="card-title t-primary title-xlarge"><?php echo $categoria->name; ?></h3></a>
