<?php
global $posts, $the_query, $load_posts, $load_card_type;
...
<div class="bg-grey-card py-5">
    <div class="container">
        <h2 class="text-secondary mb-4">Esplora tutte le novità</h2>
                ...
                <div class="cmp-input-search">
                    <div class="form-group autocomplete-wrapper">
                        ...
                        <p id="autocomplete-label" class="u-grey-light text-paragraph-card mt-2 mb-30 mt-lg-3 mb-lg-40">
                            <?php echo $the_query->post_count ?> notizie elencate dalla più recente
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="row g-4" id="load-more">
            ...
            foreach ($posts as $post) {
                ...
                get_template_part('template-parts/notizia/cards-list');
            } ?>
        </div>
