...
$link_schede_documenti = dci_get_meta("link_schede_documenti");
$file_documenti = dci_get_meta("file_documenti");
$luoghi = dci_get_meta("luoghi");
$persone = dci_get_meta("persone");
$numerazione_circolare = dci_get_meta("numerazione_circolare");
            ...
            <div class="row variable-gutters">
                <div class="col-md-<?php echo $colsize; ?> article-title-author-container">
                    <div class="title-content">
                        <h1><?php the_title(); ?></h1>
                        <p class="mb-0"><?php echo dci_get_meta("descrizione"); ?></p>
                    </div><!-- /title-content -->
