		...
		<div class="container">
			...
			<div class="row variable-gutters">
				<div class="col-lg-12">
					...
					<h3 class="mb-4 text-center semi-bold text-gray-primary"><?php _e( "Altri contenuti che potrebbero interessarti", "design_comuni_italia" ); ?></h3>

					<div class="badges-wrapper text-center mt-0 mb-4">
						<small><strong><?php _e( "Contenuti filtrati per:", "design_comuni_italia" ); ?></strong>
						</small>
									...
									<div class="card card-bg h-100 rounded">
										<div class="card-body">
											<div class="card-header accordion-header">
												...
												<span><?php _e( "Servizi", "design_comuni_italia" ); ?></span>
									...
									<div class="card card-bg h-100 rounded">
										<div class="card-body">
											<div class="card-header accordion-header">
												...
												<span><?php _e( "Notizie", "design_comuni_italia" ); ?></span>
											</div><!-- /accordion-header -->
											<div class="card-content accordion-content">
												<ul>
													<?php
									...
									<div class="card card-bg h-100 rounded">
										<div class="card-body">
											<div class="card-header accordion-header">
												...
												<span><?php _e( "Documenti", "design_comuni_italia" ); ?></span>
											</div><!-- /accordion-header -->
											<div class="card-content accordion-content">
												<ul>
													<?php
