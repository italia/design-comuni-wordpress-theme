...
<div class="cmp-icon-link">
    <a class="list-item icon-left d-inline-block" href="<?php echo $file_url; ?>" aria-label="Scarica Termini e condizioni di servizio (<?php echo $extension.' '.$size; ?>)" title="Scarica Termini e condizioni di servizio (<?php echo $extension.' '.$size; ?>)">
