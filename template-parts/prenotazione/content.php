                  ...
                  <div class="card-body p-0">
                    <div class="select-wrapper p-0 select-partials">
                      ...
                      <select id="office-choice" class="">
                        ...
                        <option
                          value="Affari generali, amministrativi e contabili"
                        >
                          Affari generali, amministrativi e contabili
                        </option>
                        <option value="Albo pretorio">Albo pretorio</option>
                        <option value="Amministrativo">Amministrativo</option>
                        <option value="Amministrativo lavori pubblici">
                          Amministrativo lavori pubblici
                        </option>
                        <option value="Amministrativo patrimonio">
                          Amministrativo patrimonio
                        </option>
                        <option value="Amministrativo sport">
                          Amministrativo sport
                        </option>
                        <option value="Anagrafe">Anagrafe</option>
                        <option
                          value="Anticorruzione, trasparenza, controlli interni, antiriciclaggio, antifrode"
                        >
                          Anticorruzione, trasparenza, controlli interni,
                          antiriciclaggio, antifrode
                        </option>
                        <option value="Asili nido">Asili nido</option>
                        <option value="Assistenza tecnica">
                          Assistenza tecnica
                        </option>
                        ...
                        <option value="Commercio e somministrazione">
                          Commercio e somministrazione
                        </option>
                        <option
                          value="Concessione occasionale suolo pubblico (Cosp)"
                        >
                          Concessione occasionale suolo pubblico (Cosp)
                        </option>
                      </select>
                    </div>
                ...
                <nav class="steppers-nav">
                  ...
                  >
                    <svg class="icon icon-primary icon-sm">
                      <use
                        href="./assets/bootstrap-italia/dist/svg/sprite.svg#it-chevron-left"
                      ></use>
                    </svg>
                  ...
                  >
                    ...
                    <svg class="icon icon-white icon-sm">
                      <use
                        href="./assets/bootstrap-italia/dist/svg/sprite.svg#it-chevron-right"
                      ></use>
                    </svg>
                  </button>
                </nav>
