...
$class = dci_get_post_types_color_class($post->post_type);
$icon = dci_get_post_types_icon_class($post->post_type);
...
$timestamp_inizio = dci_get_meta("timestamp_inizio", "_dci_evento_", $post->ID);
$timestamp_fine= dci_get_meta("timestamp_fine", "_dci_evento_", $post->ID);
?>
