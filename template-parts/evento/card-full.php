        ...
        <div class="card card-img no-after rounded">
            ...
            <div class="card-body">
                <div class="category-top cmp-list-card-img__body">
                    <a class="text-decoration-none fw-bold cmp-list-card-img__body-heading-title" href="<?php echo get_term_link($tipo_evento->term_id); ?>" aria-label="Vai alla categoria <?php echo $tipo_evento->name; ?>" title="Vai alla categoria <?php echo $tipo_evento->name; ?>">
                ...
                <a
                    ...
                    href="<?php echo get_permalink($post->ID); ?>" title="Leggi di più sulla pagina di <?php echo $post->post_title ?>" aria-label="Leggi di più sulla pagina di <?php echo $post->post_title ?>"
