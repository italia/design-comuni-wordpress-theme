        ...
        <div class="card card-img no-after rounded">
            ...
            <div class="card-body">
                <div class="category-top cmp-list-card-img__body">
                    ...
                    ?>
                        <a class="category cmp-list-card-img__body-heading-title underline" href="<?php echo get_term_link($tipo_luogo->term_id); ?>" aria-label="Vai alla categoria <?php echo $tipo_luogo->name; ?>" title="Vai alla categoria <?php echo $tipo_luogo->name; ?>">
                            <?php 
                                echo $count == 1 ? '' : ' - ';
