    ...
    public function user_profile($user) {
        ...
        foreach(self::$taxonomies as $key=>$taxonomy):
            ...
            <table class="form-table">
                <tr>
                    <th><label for=""><?php _e("Seleziona {$taxonomy->labels->singular_name}", "design_comuni_italia")?></label></th>
                    <td>
                        <?php if(!empty($terms)):?>
                        ...
                        <?php else:?>
                            <?php _e("Non è stato creato ancora nessun  {$taxonomy->labels->name}.", "design_comuni_italia")?>
                        <?php endif?>
                    </td>
                </tr>
            </table>
        ...
        $output	= ob_get_clean();
        if(!empty($output)) {
//            echo '<h3>', __('Tassonomia', "design_comuni_italia"), '</h3>';
            echo $output;
        }
    }
